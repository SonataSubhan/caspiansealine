...
import { fleetPage, vessels } from "@/content/en/fleet";
import { home } from "@/content/en/home";

const BREADCRUMB = [{ label: "Fleet", href: "/fleet" }];
...
export default function FleetPage() {
  return (
    <>
      <JsonLd
        schema={[
          webPageSchema({ path: "/fleet", name: fleetPage.meta.title, description: fleetPage.meta.description }),
